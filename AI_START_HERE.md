...
10. Exactly one updater binary is produced by work; the game branch selector cannot change self-update source. A selected game branch still requires its own exact HEAD, compatible registered DLLs and finalized runtime package.
