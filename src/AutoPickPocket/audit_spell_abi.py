...
def main():
    ...
    for name,va in (("historical_CastSpell_GUID",0x0080DA40),("historical_GetSpellIdByName",0x00540200)):
    ...
    print("PP_NATIVE_AUDIT: STATIC_CANDIDATES_ONLY; ABI/game-thread/dispatch and result correlation unverified")
