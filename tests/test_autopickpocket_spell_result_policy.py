...
class SpellAndResultTests(unittest.TestCase):
    ...
    def test_exact_attempt_cancellation_unifies_timers(self):
        ...
        self.assertIn("PP_BURST_OBSERVE_MS 900u",core_header)
        self.assertIn("PP_BURST_RANGE_RELEASE_MS 350u",core_header)
        self.assertIn("PP_BURST_UNKNOWN_BACKOFF_MS 200u",core_header)
        self.assertIn("PP_EVENT_BURST_RANGE_RELEASE",core)
        self.assertIn("range_exit_cancelled_pending_short_backoff",HOST)
