...
class SpellAndResultTests(unittest.TestCase):
    ...
    def test_exact_attempt_cancellation_unifies_timers(self):
        ...
        self.assertIn("PP_RESULT_TIMEOUT_MS 560u",core_header)
        self.assertIn("PP_RESULT_EARLY_RELEASE_MS 420u",core_header)
        ...
        self.assertIn("same(guid,current_target)) {",POLICY)
        self.assertIn("uncertain_until_ms=GetTickCount()+1500u;",POLICY)
        self.assertIn("        clear();",POLICY)
