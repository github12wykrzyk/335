...
class EspRenderIntegration(unittest.TestCase):
    def test_one_owner_and_camera_on_game_thread(self):
        ...
        self.assertIn("esp335_camera_build(&a,camera)",h)
        self.assertIn("esp335_d3d9_draw_labels(device,",h)
        self.assertIn("g_scanner.snapshot.world_epoch != epoch(NULL)",h)
    ...
    def test_fails_closed_for_unknown_metadata(self):
        ...
        self.assertIn("filter.show_all=1u", (ROOT/"src/PlayerESP/player_esp_win32_host.c").read_text())
